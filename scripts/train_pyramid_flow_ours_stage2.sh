...
OUTPUT_DIR=/data/cvpr25/Pyramid-Flow/result/stage2-duplicate    # The checkpoint saving dir
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 accelerate launch --multi_gpu --num_processes $GPUS \
    ...
    --dit_pretrained_weight ./result/stage1/checkpoint-1000-2/pytorch_model_fsdp.bin