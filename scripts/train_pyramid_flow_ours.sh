...
OUTPUT_DIR=/data/cvpr25/Pyramid-Flow/result/Stage1-noise-downsample-autoregressive-condition-original-image    # The checkpoint saving dir
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 accelerate launch --multi_gpu --num_processes $GPUS \
    train/train_pyramid_flow_ours_stage1.py \
    --num_workers 4 \
    --task t2v \
    --use_fsdp \
