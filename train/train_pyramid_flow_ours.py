...
def get_args():
    ...
    # Added by us
    parser.add_argument('--num_frames', default=128, type=int, help='number of frames in a video')
    parser.add_argument('--frame_interval', default=1, type=int, help='frame interval')
    parser.add_argument('--image_size', default=(1024, 1280), type=tuple, help='image size')
